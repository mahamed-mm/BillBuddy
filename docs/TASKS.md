...
- [ ] **2A-12** Keyboard focus flow across bill and person fields (~2h) · deps: 2A-11, 2A-15
  ...
  - AC (Q10, 2A-18 [B1]): on the iOS 17.5 simulator with the device appearance set to Light, the toolbar's ∧, ∨, and Done show `#00E5CC` (the toolbar sits outside the forced-dark window); the PR includes a screenshot
...
- [ ] **2A-14** Docs and manual QA sweep (~1h) · deps: 2A-1 to 2A-13, 2A-15 to 2A-18
  ...
  - AC: manual QA with Region = Norway, on the default simulator and the iOS 17.5 one (2A-15): bill "12,50" computes, and a 3-person custom split works end to end in all 4 rounding modes, starting from the automatic equal split; on iOS 17.5 with the device appearance set to Light, the keyboard toolbar's Done is `#00E5CC` (Q10)
